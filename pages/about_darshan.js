        ...
        <div className="ad_mainbox">
                <div className="ad_box_0">
                    ...
                    <div className="ad_box1_0"><b>
                        ...
                        <div className="ad_text2_0">I'm Darshan</div>
                ...
                <div className="ad_box3">
                    <div className="ad_box4">
                        ...
                        <div className="ad_rect2"><img src="d_img.jpg" className="jeel_image" /></div>
                    </div>
                    <div className="ad_box5"><b>
                        <div className="ad_text3">About Me</div>
                        <hr className="ad_line1_0"/>
                            <div className="ad_text4">My name is Darshan Kantesariya and I am founder of BestContent.com. I am a Web
                    ...
                    <div className="ad_box6">
                        <div className="ad_box7">
                            ...
                            <hr className="ad_line1_0"/>
                                <div className="ad_text6"><b>This website has been created by us(me and my friend jeel).I have also created an
